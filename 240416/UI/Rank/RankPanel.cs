...
public class RankPanel : MonoBehaviour
{
    ...
    Tab SelectedTab
    {
        ...
        set
        {
            ...
            {
                selectedTab.IsSelected = false; // 이전 것은 선택 해제
                selectedTab = value;
                selectedTab.IsSelected = true;  // 새 것을 선택
            }
        }
    }

    /// <summary>
    /// 이 패널이 사용하는 토글 버튼 (탭의 서브 패널 열고 닫기용)
    /// </summary>
    ToggleButton toggle;
    ...
    private void Start()
    {
        ...
        gameManager.onGameReady += Close;   // 게임 Ready일 때 닫기
        Close();                            // 시작하자마자 닫기
    }
